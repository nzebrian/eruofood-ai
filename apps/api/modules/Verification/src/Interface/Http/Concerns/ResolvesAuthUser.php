...
namespace EruoFood\Verification\Interface\Http\Concerns;
 ...
 *
 * Module-local, so Verification depends on the request contract rather than on
 * Identity's internals — the same choice Payments made.
 */
