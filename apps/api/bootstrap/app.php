    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        $exceptions->render(function (DomainException $e, Request $request): ?JsonResponse {
            ...
            $status = match ($e->errorCode()) {
                ...
                'SEARCH_RESOURCE_NOT_FOUND', 'SUPPORT_RESOURCE_NOT_FOUND' => 404,
                ...
                'SEARCH_NOT_AUTHORIZED', 'SUPPORT_NOT_AUTHORIZED' => 403,
                ...
                'SEARCH_INVALID_QUERY', 'SUPPORT_INVALID_STATE' => 422,
