    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        $exceptions->render(function (DomainException $e, Request $request): ?JsonResponse {
            ...
            $status = match ($e->errorCode()) {
                ...
                'REVIEWS_RESOURCE_NOT_FOUND', 'LOYALTY_RESOURCE_NOT_FOUND' => 404,
                ...
                'SUPPORT_CONFLICT', 'REVIEWS_CONFLICT', 'LOYALTY_CONFLICT' => 409,
                ...
                'REVIEWS_NOT_AUTHORIZED', 'LOYALTY_NOT_AUTHORIZED' => 403,
                ...
                'REVIEWS_INVALID_STATE', 'LOYALTY_INVALID_STATE' => 422,
